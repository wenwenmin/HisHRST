...
parser.add_argument('--dataDir', type=str, nargs=1, default='D:\dataset\DLPFC/',
                    required=argrequired,
                    help='Data directory (default: ')

parser.add_argument('--outDir', type=str, nargs=1, default='./output/',
                    help='Root directory (default: ')

parser.add_argument('--sampleNames_train', type=str, nargs=1, default='151507',
                    help='Sample names to train (default: Human_Breast_Cancer_Block_A_Section_1)')

parser.add_argument('--sampleNames_test', type=str, nargs=1, default='151507',
...
parser.add_argument('--clusteringMethod', type=str, nargs=1,
                    choices=['graphclust', 'kmeans_2_clusters', 'kmeans_3_clusters', 'kmeans_4_clusters',
                             'kmeans_5_clusters', 'kmeans_6_clusters', 'kmeans_7_clusters', 'kmeans_8_clusters',
                             'kmeans_9_clusters', 'kmeans_10_clusters'], default='graphclust',
...
#     data_list_semi.head()
#
#     data_list_semi.to_csv("../out/data_list_semi" + str(i_semi + 1) + ".txt", index=False, sep='\t',
#                           float_format='%.6f')
#
#     ## add semi dataset
...
#         count += 1
#
#     data_list_student.to_csv("../out/data_list_student" + str(i_semi + 1) + ".txt", index=False, sep='\t',
#                              float_format='%.6f')
#
...
#                                                 name="student" + str(i_semi + 1))
#
#     data_list_test_student.to_csv("../out/data_list_test_student" + str(i_semi + 1) + ".txt", index=False, sep='\t',
#                                   float_format='%.6f')
#
