...
parser.add_argument('--modelName', type=str,
                    choices=['teacher', 'student1', 'student2', 'student3', 'student4', 'student5'], default='teacher',
...
image_list = pd.DataFrame(
    columns=['Sample', 'No', 'pos_x1', 'pos_y1', 'radius', 'ImageFilter', 'image_path', 'mean_RGB'])

for sample in sampleNames:
    tmp = pd.read_csv(dataDir + "/" + sample + "/CropImage/size_" + str(extraSize) + "/RGB_" + str(
        quantileRGB) + "/image_list_inter.txt", sep='\t')
    tmp['Sample'] = sample
